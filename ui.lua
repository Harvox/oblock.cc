...
do
    ...
    do
        function Menu.Draw(Type : String, Properties : Table, Table : Table)
            ...
            if StringFind(Lower(Type), "text") then
                ...
                for Index, Value in next, Font do
                    Render[Index] = Value
                end
            end
    ...
    do
        ...
        function Menu.GetTextBounds(Text : String, FontFace : Table)
            for Index, Value in next, FontFace do
                Cache.TextBoundsLabel[Index] = Value
            end

            Cache.TextBoundsLabel.Text = Text

            return Cache.TextBoundsLabel.TextBounds
        end

        Fonts = {
            ["Minecraftia"] = {
                ["FontFace"] = Menu.ImportFont("Minecraftia", EncodedAssets["Minecraftia"]),
                ["TextSize"] = 10,
    ...
    do
        ...
        Cache.TextBoundsLabel = Menu.Draw("TextLabel", { Parent = Menu.Overlay, Text = "", RichText = true, Visible = true, TextTransparency = 1, BackgroundTransparency = 1, BorderSizePixel = 0 })
    end
    ...
    do
        function Menu.CreateWindow(Parameters)
            ...
            do
                ...
                Menu.Draw("TextLabel", {Parent = Outline2, Text = Name, FontFace = Fonts.Minecraftia, TextXAlignment = "Left", Position = NewUDim2(0, 5, 0, 11), TextStrokeTransparency = 0, Visible = true, BorderSizePixel = 0})
                ...
                local Temp = Menu.Draw("Frame", {Parent = Outline2, Position = NewUDim2(0, 5, 0, 21), Size = NewUDim2(1, -10, 0, 25), BackgroundColor3 = NewRGB(255, 255, 255), BorderSizePixel = 0})

                local TabsHolder = Menu.Draw("Frame", {Parent = Temp, Position = NewUDim2(0, 1, 0, 1), Size = NewUDim2(1, -2, 1, -1), BackgroundTransparency = 1})
                local NotifcationsHolder = Menu.Draw("Frame", {Parent = Menu.Overlay, BackgroundTransparency = 1, Position = NewUDim2(0, 50, 0, 30), Size = NewUDim2(0, 300, 0, 200)})
            ...
            do
                function Window.CreateTab(Parameters)
                    ...
                    -- Renders
                    do
                        local Frame = Menu.Draw("Frame", {Parent = Window["Tabs Holder"], Position = NewUDim2(0, 5 + (63 * #Window.Tabs), 0, 3), Size = NewUDim2(0, 59, 0, 16), BorderSizePixel = 0, BackgroundColor3 = NewRGB(255, 255, 255), BackgroundTransparency = 1})
                        ...
                        local Button = Menu.Draw("TextButton", {Parent = Frame, BackgroundTransparency = 1, Position = NewUDim2(0, 0, 0, 0), Size = NewUDim2(1, 0, 1, 0), TextTransparency = 1, TextStrokeTransparency = 1})

                        local SectionsHolder = Menu.Draw("Frame", {Parent = Window.Background, Position = NewUDim2(0, 12, 0, 10), Size = NewUDim2(1, -24, 1, -50), BackgroundTransparency = 1, Visible = false})

                        local Left = Menu.Draw("Frame", { Parent = SectionsHolder, Position = NewUDim2(0, -6, 0, 0), Size = NewUDim2(0.5, 1, 1, -40), BackgroundTransparency = 1, BorderSizePixel = 0 })
                        local Right = Menu.Draw("Frame", { Parent = SectionsHolder, Position = NewUDim2(0.5, 6, 0, 0), Size = NewUDim2(0.5, 0, 1, -40), BackgroundTransparency = 1, BorderSizePixel = 0 })
                ...
                function Window.Notify(Parameters)
                    ...
                    do
                        ...
                        local Background = Menu.Draw("Frame", {Parent = Inline, BackgroundColor3 = NewRGB(255, 255, 255), BorderSizePixel = 0, Size = NewUDim2(1, -2, 1, -2), Position = NewUDim2(0, 1, 0, 1)})
                        ...
                        local VerticalBar = Menu.Draw("Frame", {Parent = Background, BackgroundColor3 = Color, BorderSizePixel = 0, Size = NewUDim2(0, 1, 0, 0), Position = NewUDim2(0, 0, 0, 0)})
            ...
            do
                function Tabs:Section(Parameters)
                    ...
                    -- Renders
                    do
                        local Frame = Menu.Draw("Frame", { Parent = Tab[Side], Size = NewUDim2(1, 0, 0, Fill and Tab["Sections Holder"].AbsoluteSize.Y + (-Tab.Offsets[Side] + 11) or Size), BorderColor3 = Theme.C, BackgroundColor3 = Theme.B })

                        Menu.Draw("TextLabel", { Parent = Frame, Position = NewUDim2(0, 7, 0, 0), Text = Name, TextXAlignment = "Left", TextStrokeTransparency = 0 })
                ...
                function Tabs:Find(Name)
                    ...
                    for i = 1, #Tab.Sections do
                        local Section = Tab.Sections[i]

                        if Section.Name and Section.Name == Name then
                            return Section
                        end
                    end
                end
                ...
                function Tabs:Open()
                    ...
                    if CurrentTab then
                        Menu.Tween(Tab.Frame, NewTweenInfo(0.15, Enum.EasingStyle.Linear), { BackgroundTransparency = 0 })
                        Menu.Tween(Tab.Label, NewTweenInfo(0.15, Enum.EasingStyle.Linear), { TextColor3 = NewRGB(255, 255, 255) })
                        ...
                        Tab.Label.TextColor3 = NewRGB(255, 255, 255)
            ...
            do
                function Sections:Toggle(Parameters)
                    ...
                    do
                        ...
                        local Box = Menu.Draw("Frame", { Parent = Frame, Position = NewUDim2(0, 6, 0, 1), Size = NewUDim2(0, 9, 0, 9), BackgroundColor3 = NewRGB(255, 255, 255), BorderSizePixel = 0 })
                        ...
                        local Label = Menu.Draw("TextLabel", { Parent = Frame, Position = NewUDim2(0, 19, 0, 6), TextColor3 = NewRGB(175, 175, 175), BackgroundTransparency = 1, TextXAlignment = "Left", Text = Name, TextStrokeTransparency = 0 })
                    ...
                    do
                        ...
                        function Toggle.Set(Boolean, Test)
                ...
                function Sections:Dropdown(Parameters)
                    ...
                    do
                        ...
                        local Inline = Menu.Draw("Frame", {Parent = Outline, Position = NewUDim2(0, 1, 0, 1), Size = NewUDim2(1, -2, 1, -2), BackgroundColor3 = NewRGB(255, 255, 255), BorderSizePixel = 0})

                        Menu.Draw("UIGradient", {Parent = Inline, Color = NewColorSequence(NewRGB(15, 15, 15), NewRGB(23, 23, 23)), Rotation = -90})

                        local Button = Menu.Draw("TextButton", {Parent = Outline, Size = NewUDim2(1, 0, 1, 0), Position = NewUDim2(0, 0, 0, 0), BackgroundTransparency = 1, Text = ""})
                        ...
                        local HoverFrame = Menu.Draw("Frame", { Parent = Inline, BackgroundTransparency = 1, BorderSizePixel = 0, Size = NewUDim2(1, 0, 1, 0), BackgroundColor3 = NewRGB(161, 161, 161), Position = NewUDim2(0, 0, 0, 0) })
                    ...
                    do
                        ...
                        function Dropdown.Open()
                            ...
                            -- Renders
                            do
                                local Frame = Menu.Draw("Frame", {Parent = Dropdown.Outline, ZIndex = 30000, Position = NewUDim2(0, 0, 1, 2), Size = NewUDim2(1, 0, 0, 0), BackgroundColor3 = Theme.A, ClipsDescendants = true, BackgroundTransparency = 1, BorderSizePixel = 0})
                                local Inner = Menu.Draw("Frame", {Parent = Frame, ZIndex = Frame.ZIndex + 1, Position = NewUDim2(0, 1, 0, 1), Size = NewUDim2(1, -2, 1, -2), BackgroundColor3 = NewRGB(255, 255, 255), BorderSizePixel = 0})

                                Menu.Draw("UIGradient", {Parent = Inner, Color = NewColorSequence(NewRGB(15, 15, 15), NewRGB(23, 23, 23)), Rotation = -90})

                                Connections[#Connections + 1] = Frame:GetPropertyChangedSignal("BackgroundTransparency"):Connect(function()
                            ...
                            do
                                for i = 1, #Dropdown.Options do
                                    ...
                                    local Frame2 = Menu.Draw("TextButton", {Parent = Dropdown.Inner, ZIndex = Dropdown.Inner.ZIndex + 1, Position = NewUDim2(0, 0, 0, 0), Size = NewUDim2(1, 0, 0, 0), BackgroundColor3 = NewRGB(30, 30, 30), BorderSizePixel = 0, Text = "", BackgroundTransparency = 1, AutomaticSize = "Y"})
                ...
                function Sections:Slider(Parameters)
                    ...
                    do
                        ...
                        local Button2 = Menu.Draw("ImageButton", {Parent = Button, Position = NewUDim2(0, 0, 0, 0), Size = NewUDim2((Slider.Value - Slider.Min) / (Slider.Max - Slider.Min), 0, 1, 0), Image = Images.Gradient, ImageTransparency = 0.1, BackgroundColor3 = Theme.Accent, BorderSizePixel = 0, Interactable = false})
                        ...
                        local HoverFrame = Menu.Draw("Frame", { Parent = Button, BackgroundTransparency = 1, BorderSizePixel = 0, Size = NewUDim2(1, 0, 1, 0), BackgroundColor3 = NewRGB(161, 161, 161), Position = NewUDim2(0, 0, 0, 0) })
                ...
                function Sections:TextBox(Parameters)
                    ...
                    do
                        ...
                        local Box = Menu.Draw("TextBox", {Parent = Inline, Position = NewUDim2(0, 0, 0, 0), Size = NewUDim2(1, 0, 1, 0), BackgroundTransparency = 1, BorderSizePixel = 0, PlaceholderText = PlaceholderText, Text = Default, ClipsDescendants = true})
                ...
                function Sections:Button(Parameters)
                    ...
                    local PassedCallback = Parameters.Callback or function() end
                    ...
                    do
                        ...
                        local TextButton = Menu.Draw("TextButton", {Parent = Outline, Position = NewUDim2(0, 0, 0, 0), Size = NewUDim2(1, 0, 1, 0), BackgroundTransparency = 1, Text = ""})
                ...
                function Sections:DoubleButton(Parameters)
                    ...
                    return { Unpack(DoubleButton.Buttons) }, DoubleButton
                end
                ...
                function Sections:List(Parameters)
                    ...
                    do
                        ...
                        function List.SetValue(Value)
                            ...
                            if List.Chosen then
                                List.Chosen.TextColor3 = NewRGB(255, 255, 255)
                            end
                ...
                function Sections:Label(Parameters)
                    ...
                    do
                        ...
                        function Label.SetText(String)
                            if typeof(String) == 'table' then 
                                table.foreach(String, print)
                            end 
                            Label.TextLabel.Text = tostring(String)
            ...
            do
                function Elements:Colorpicker(Parameters)
                    ...
                    do
                        ...
                        function Colorpicker.Open()
                            ...
                            -- Valsat
                            do
                                local ValsatFrame = Menu.Draw("ImageButton", {Parent = Colorpicker.PickerInline, Position = NewUDim2(0, 4, 0, 4), Size = NewUDim2(1, -23, 1, IsTransparency and -23 or -8), BackgroundColor3 = NewRGB(255, 255, 255), ImageColor3 = FromHSV(H, 1, 1), Image = Images["Colorpicker Valsat 3"], BorderColor3 = Theme.A, ImageTransparency = 0, ZIndex = Colorpicker.PickerInline.ZIndex + 1})
                            ...
                            -- Hue
                            do
                                local HueFrame = Menu.Draw("ImageButton", {Parent = Colorpicker.PickerInline, Position = NewUDim2(1, -14, 0, 4), Size = NewUDim2(0, 10, 1, IsTransparency and -23 or -8), BackgroundColor3 = NewRGB(255, 255, 255), Image = Images["Colorpicker Hue2"], ScaleType = "Crop", BorderColor3 = Theme.A, BackgroundTransparency = 1, ImageTransparency = 1, Rotation = 180, ZIndex = Colorpicker.PickerInline.ZIndex + 1})

                                local HueCursor = Menu.Draw("Frame", {Parent = HueFrame, Position = NewUDim2(0, 0, H, -1), Size = NewUDim2(0, 10, 0, 1), BackgroundTransparency = 1, BackgroundColor3 = NewRGB(255, 255, 255), BorderColor3 = Theme.A, ZIndex = HueFrame.ZIndex + 1})
                            ...
                            do
                                if IsTransparency then
                                    ...
                                    local TransparencyCursor = Menu.Draw("Frame", {Parent = TransparencyFrame, Position = NewUDim2(Transparency, -1, 0, 0), Size = NewUDim2(0, 1, 0, 10), BackgroundTransparency = 1, BackgroundColor3 = NewRGB(255, 255, 255), ZIndex = TransparencyFrame.ZIndex + 1})

                                    local GradientFrame = Menu.Draw("ImageLabel", {Parent = TransparencyFrame, Position = NewUDim2(0, 0, 0, 0), Size = NewUDim2(1, 0, 1, 0), BackgroundTransparency = 1, ImageColor3 = Color, ZIndex = TransparencyCursor.ZIndex - 1, Image = Images["Colorpicker Overlay 6"]})
                    ...
                    do
                        function Binds.Open()
                            ...
                            do
                                ...
                                Menu.Draw("UIListLayout", { Parent = Inline, Padding = NewUDim(0, 0), FillDirection = "Vertical", VerticalFlex = "SpaceAround", HorizontalAlignment = "Center" })
                            ...
                            do
                                ...
                                Connections[#Connections + 1] = ResetButton.MouseButton1Down:Connect(function()
                                    ...
                                    Delay(0.35, function()
                                        ResetButton.TextColor3 = NewRGB(255, 255, 255)
                                    end)
                                end)
                                ...
                                Connections[#Connections + 1] = CopyButton.MouseButton1Down:Connect(function()
                                    ...
                                    Delay(0.35, function()
                                        CopyButton.TextColor3 = NewRGB(255, 255, 255)
                                    end)
                                end)
                                ...
                                Connections[#Connections + 1] = PasteButton.MouseButton1Down:Connect(function()
                                    ...
                                    Delay(0.35, function()
                                        PasteButton.TextColor3 = NewRGB(255, 255, 255)
                                    end)
                                end)
                                ...
                                Connections[#Connections + 1] = RainbowButton.MouseButton1Down:Connect(function()
                                    ...
                                    Delay(0.35, function()
                                        RainbowButton.TextColor3 = NewRGB(255, 255, 255)
                                    end)
                                end)
                            end
                ...
                function Elements:Keybind(Parameters)
                    ...
                    local Activated = Parameters.Activated or function() end
                    local Callback = Parameters.Callback or function() end
                    local Flag = Parameters.Flag
                        ...
                        function Keybind.Open()
                            ...
                            do
                                for i = 1, #Keybind.Modes do
                                    ...
                                    local ModeButton = Menu.Draw("TextButton", { Parent = Keybind.PickerInline, Size = NewUDim2(1, 0, 0, 15), TextColor3 = KeyMode == Keybind.Mode and Theme.Accent or NewRGB(255, 255, 255), BackgroundTransparency = 1, BorderSizePixel = 0, Text = KeyMode, TextTransparency = 1, TextStrokeTransparency = 0 })
        ...
        function Menu.CreateWatermark(Parameters)
            ...
            do
                ...
                local Inline = Menu.Draw("Frame", {Parent = Outline, BackgroundColor3 = NewRGB(255, 255, 255), Size = NewUDim2(1, -2, 1, -2), Position = NewUDim2(0, 1, 0, 1), BorderSizePixel = 0})

                Menu.Draw("Frame", {Parent = Inline, Position = NewUDim2(0, 0, 0, 0), Size = NewUDim2(1, 0, 0, 1), BackgroundColor3 = Theme.Accent, BorderSizePixel = 0})
        ...
        function Menu.CreateKeybindsList(Parameters)
            ...
            do
                ...
                function KeybindsList.Add(Keybind)
                    ...
                    Keybind.Updated = function()
                        Label.TextColor3 = Keybind.Active and Theme.Accent or Fonts.Minecraftia.TextColor3
